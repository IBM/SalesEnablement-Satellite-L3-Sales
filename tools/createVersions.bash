...
echo "Retrieving your IBM Cloud Unique ID using command: ibmcloud account user-preference"
...
createVersions() {
    ...
    echo "    		ibmcloud sat config version create -name ${yamlBaseName} --read-config ${yamlBaseName}.yaml --config ${configUUID} --file-format yaml"
