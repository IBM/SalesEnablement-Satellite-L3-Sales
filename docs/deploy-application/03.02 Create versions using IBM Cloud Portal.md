...
!!! warning
    Notice, one **Version** already exists in your configuration. This **Version** was used to create the OpenShift project where you will be deploying the application. Do **NOT** delete any existing versions or subscriptions! Deleting them will break your demonstration environment. Recently the **Rollout status** for this subscription started showing errors. That is OK and can be ignored. The issue has been reported and is being investigated.
