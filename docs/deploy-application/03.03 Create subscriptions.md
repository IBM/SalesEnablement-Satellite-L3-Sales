...
|-----------------------------------|---------------------------|------------------------------------|
| kafka-mongo-redis-on-all-clusters | kafka-mongo-redis         | {{ appdeployment.dev_cluster_group }}
<br> {{ appdeployment.prod_cluster_group }}|
| backend-on-all-clusters           | food-delivery-backend     | {{ appdeployment.dev_cluster_group }}
<br>{{ appdeployment.prod_cluster_group }}|
...
| route-dev                         | development-route         | f{{ appdeployment.dev_cluster_group }} |
