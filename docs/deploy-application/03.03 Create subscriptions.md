...
|-----------------------------------|---------------------------|------------------------------------|
| kafka-mongo-redis-on-all-clusters | kafka-mongo-redis         | {{ dev_cluster_group }}
<br>{{ prod_cluster_group }}|
| backend-on-all-clusters           | food-delivery-backend     | {{ dev_cluster_group }}
<br>{{ prod_cluster_group }}|
| frontend-on-dev-clusters          | food-delivery-frontend-v1 | {{ dev_cluster_group }}  |
| frontend-on-prod-clusters         | food-delivery-frontend-v1 | {{ prod_cluster_group }}  |
| route-dev                         | development-route         | f{{ dev_cluster_group }} |
| route-prod                        | production-route          | {{ prod_cluster_group }}  |
...
| frontend-on-dev-clusters   | food-delivery-frontend-v1 |  {{ dev_cluster_group }}  |
| frontend-on-prod-clusters  | food-delivery-frontend-v1 |  {{ prod_cluster_group }} |
| route-dev                  | development-route         |  {{ dev_cluster_group }}  |
| route-prod                 | production-route          |  {{ prod_cluster_group }} |
